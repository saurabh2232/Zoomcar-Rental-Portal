...
$to_date=date("Y-m-d", strtotime("+1 month", date('Y-m-d')))
?>
...
<title>Zoomcar Rental | Vehicle Details</title>
<!--Bootstrap -->
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="fromdate" placeholder="From Date" id='from_date'  min="<?php echo $from_date; ?>" required>
            </div>
            <div class="form-group">
              <label>To Date:</label>
              <input type="date" class="form-control" name="todate" placeholder="To Date" id='to_date' min="<?php echo $from_date; ?>" required>
            </div>
            <div class="form-group">
...
<script>
  $(document).ready(function(){
    ...
    $('#to_date').attr('max',date.getFullYear()+'-'+no((date.getMonth()+2))+'-'+no(date.getDate()));
    });
  });
  function no(n){
    return n > 9 ? "" + n: "0" + n;
