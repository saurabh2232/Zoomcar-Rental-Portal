...
<head>
	...
	<title>Zoom-Car | New Bookings   </title>
...
{				?>	
	<h3 style="text-align:center; color:red">CRPSS<?php echo htmlentities($result->BookingNumber);?> Booking Details </h3>
		...
		<tr>
										...
										<tr>
											<th>Booking No.</th>
											<td>CRPSS<?php echo htmlentities($result->BookingNumber);?></td>
											<th>Name</th>
